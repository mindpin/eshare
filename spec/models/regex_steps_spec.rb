...
describe RegexStep do

  before {
    @course_ware_1 = FactoryGirl.create(:course_ware, :kind => 'regex')
    @course_ware_2 = FactoryGirl.create(:course_ware, :kind => 'regex')

    @step_1_1 = @course_ware_1.regex_steps.create(:content => "content_1", :rule => "rule_1")
    @step_2_1 = @course_ware_2.regex_steps.create(:content => "content_2", :rule => "rule_2")
    @step_1_2 = @course_ware_1.regex_steps.create(:content => "content_3", :rule => "rule_3")
    @step_2_2 = @course_ware_2.regex_steps.create(:content => "content_4", :rule => "rule_4")
    @step_2_3 = @course_ware_2.regex_steps.create(:content => "content_5", :rule => "rule_5")
  }
  ...
  describe 'course_ware.total_count' do
    ...
    it{
      @course_ware_2.regex_steps.create(:content => "content_6", :rule => "rule_6")
      @course_ware_2.reload
