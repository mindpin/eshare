...
describe CourseDepend do
  ...
  describe "before_courses" do
  	...
  	it "course_3" do
  		@course_3.before_courses.should =~ [@course_1, @course_2]
  	end
  ...
  describe "after_courses" do
  	...
  	it "course_2" do
  		@course_2.before_courses.should =~ [@course_3, @course_4]
  	end

  	it "course_3" do
  		@course_3.before_courses.should =~ [@course_4]
  	end

  	it "course_4" do
  		@course_4.before_courses.should =~ []
  	end
