...
describe SqlStep do
  ...
  before {
    @course_ware_1 = FactoryGirl.create(:course_ware, :kind => 'sql')
    @course_ware_2 = FactoryGirl.create(:course_ware, :kind => 'sql')

    @step_1_1 = FactoryGirl.create(:sql_step, :course_ware => @course_ware_1, :rule => "rule_1")
    @step_2_1 = FactoryGirl.create(:sql_step, :course_ware => @course_ware_2, :rule => "rule_2")
    @step_1_2 = FactoryGirl.create(:sql_step, :course_ware => @course_ware_1, :rule => "rule_3")
    @step_2_2 = FactoryGirl.create(:sql_step, :course_ware => @course_ware_2, :rule => "rule_4")
    @step_2_3 = FactoryGirl.create(:sql_step, :course_ware => @course_ware_2, :rule => "rule_5")
  }
